...
const createWindow = () => {
  ...
  mainWindow = new BrowserWindow({
    // It is advised that you either create a custom menu bar or remove this line
    frame: true,
    webPreferences: {
  ...
  // load the index.html of the app. (or localhost on port 3000 if in development mode)
  mainWindow
    .loadURL(
      isDev
        ? "http://localhost:3000"
